...
const FACTS = [
  {
    ...
    text: 'Годовой статистический отчёт в НСИ (nsi.bg) — срок 1 янв — 30 юни. Большинство новых ООД получают штраф именно за него, потому что не знают о нём. КЕП или ПИК (для ЕТ).',
  },
  {
    icon: '🔑',
